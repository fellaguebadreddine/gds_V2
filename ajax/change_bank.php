...
$releves = Releve_comptes::trouve_releve_par_id_banque ($id_banque,$id_societe);
$Fournisseurs = Fournisseur::trouve_valid_par_societe($societes->id_societe); 
$banques= Compte::trouve_compte_par_societe($societes->id_societe); 
									...
									<?php if (isset($releve->id_tier)) {
											...
											switch ($releve->id_nature) {
												...
												case 14:
													...
													$comptes = Compte_comptable::trouve_par_id($releve->id_tier); 
