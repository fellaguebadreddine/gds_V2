...
require_once("../includes/initialiser.php");
 ...
 if ( (isset($_GET['id_user'])) && (is_numeric($_GET['id_user'])) && (isset($_GET['id_societe'])) && (is_numeric($_GET['id_societe'])) ) {
	...
	$Vente = Avoir_vente::trouve_par_id($id);
	if (isset($Vente->id)) {
		 	$Vente->supprime();
		 }	 
	 }
 	...
 	$table_vantes = Avoir_vente::trouve_vente_vide_par_admin($id_user,$id_societe);
 	$Somme_ht = Avoir_vente::somme_ht($id_user,$id_societe);
	$Somme_tva = Avoir_vente::somme_tva($id_user,$id_societe);
	$Somme_ttc = Avoir_vente::somme_ttc($id_user,$id_societe); 
