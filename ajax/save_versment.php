...
/////////////////  BEGEIN TRASACTION //////////////////////////////////////////////////////////////
		...
		if  ($versement->existe()) { ?>
			...
			$releve_comptes->id_tier = htmlentities(trim($_POST['id_client']));
			...
			$releve_comptes->somme_debit = 0;
			$releve_comptes->somme_credit = htmlentities(trim($_POST['credit']));
			$releve_comptes->libelle ='Reglement Client';
