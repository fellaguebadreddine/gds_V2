...
require_once("../includes/initialiser.php");
 ...
 if ( (isset($_GET['id_user'])) && (is_numeric($_GET['id_user'])) && (isset($_GET['id_societe'])) && (is_numeric($_GET['id_societe'])) ) {
	...
	if (isset($Achat->id)) {
 	...
 	$table_achats = Achat::trouve_achat_vide_par_admin($id_user,$id_societe);
 	$Somme_ht = Achat::somme_ht($id_user,$id_societe);
	$Somme_tva = Achat::somme_tva($id_user,$id_societe);
