...
///////////////////////////////////// ecriture Fournisseur //////////////////////////////
	...
	if (!empty($_GET['id_caisse'])) {
		$Banque_caisse = Compte::trouve_par_id($_GET['id_caisse']) ; 
	} 
	/////////////////////// ajouter piece comptable automatiquement ///////////////////////////////
	...
	$Pieces_comptables->libelle =  ' Virement Interne - '.$compte_comptables->libelle;
	...
	$Ecriture_comptable = new Ecriture_comptable();
	if (!empty( $id_banque)) {
		$Banque_caisse2 =  Compte::trouve_par_id($id_banque) ; 
	...
	if (!empty($id_caisse)) {
		$Banque_caisse2 =  Compte::trouve_par_id($id_caisse) ; 
