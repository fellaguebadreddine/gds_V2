...
if ($Achat->existe_frais()) {
	$existe_prod= Achat_importation::trouve_frais_vide_par_id_prod($Achat->id_prod,$Achat->id_person);
...
<?php
			...
			echo '  ","Attention !");
				...
				$Frais_annexes = Frais_annexe::trouve_frais_annexe_par_societe($Achat->id_societe);
 				$table_frais = Achat_importation::trouve_frais_vide_par_admin($Achat->id_person,$Achat->id_societe);
 				$Somme_ht_frais = Achat_importation::somme_ht_frais($Achat->id_person,$Achat->id_societe); 
				$Somme_tva_frais = Achat_importation::somme_tva_frais($Achat->id_person,$Achat->id_societe); 
				$Somme_ttc_frais = Achat_importation::somme_ttc_frais($Achat->id_person,$Achat->id_societe);  ?>
...
$Somme_ht_frais = Achat_importation::somme_ht_frais($id_person,$id_societe); 
...
$Achat = new Achat_importation();
	...
	if (empty($errors)){
if ($Achat->existe()) {
	$existe_prod= Achat_importation::trouve_achat_vide_par_id_prod($Achat->id_prod,$Achat->id_person);
	if (isset($existe_prod->id)) {
		$existe_prod->supprime();
	}
	...
	if (empty($errors)){
		...
		echo '<script type="text/javascript">
			...
			$("#id_fournisseur").attr("readonly","readonly");;
 			...
 			//////////////////////////////////////////////// 	
 				$achats = Achat_importation::trouve_achat_vide_par_admin($id_person,$id_societe);  
 				$Somme_ht = Achat_importation::somme_ht($id_person,$id_societe);  
				$Somme_tva = Achat_importation::somme_tva($id_person,$id_societe);  
				$Somme_ttc = Achat_importation::somme_ttc($id_person,$id_societe);   
				$last_fournisseur = Achat_importation::trouve_last_fournisseur_par_id_admin($id_person,$id_societe);  
			///////////////////////////
				$Somme_ht_frais = Achat_importation::somme_ht_frais($id_person,$id_societe);  
				$Somme_tva_frais = Achat_importation::somme_tva_frais($id_person,$id_societe);  
				$Somme_ttc_frais = Achat_importation::somme_ttc_frais($id_person,$id_societe); 
...
<?php
			...
			echo '  ","Attention !");
						...
						$Articles = Produit::trouve_produit_importation_par_societe($id_societe);
 						$table_achats = Achat_importation::trouve_achat_vide_par_admin($id_person,$id_societe); 
 						$Somme_ht = Achat_importation::somme_ht($id_person,$id_societe);  
						$Somme_tva = Achat_importation::somme_tva($id_person,$id_societe);  
						$Somme_ttc = Achat_importation::somme_ttc($id_person,$id_societe);   
						$last_fournisseur = Achat_importation::trouve_last_fournisseur_par_id_admin($id_person,$id_societe); 
