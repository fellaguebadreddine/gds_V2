...
/////////////////////////////// add new Quantité of new achat into articles and save new achat to table ACHAT ///////////////
		...
		///////////////// mise a jour de QTE stock produit ///////////////
					...
					if ($table_update_achat->Remise>0) {
						$Remise =  $table_update_achat->Remise	/ $table_update_achat->Quantite ;
						$Article->prix_achat = $table_update_achat->Prix - $Remise;
						$prix_Achat = $table_update_achat->Prix - $Remise ;
						}else{
							$Article->prix_achat = $table_update_achat->Prix;
							$prix_Achat = $table_update_achat->Prix ;
						}
					
					if ($Article->pourcentage_prix_vente > 0) {

					$Article->prix_vente = $prix_Achat +($prix_Achat * $Article->pourcentage_prix_vente) ;
					}
					$Article->modifier();
	...
	$last_achat = Achat::trouve_last_fournisseur_par_id_facture($id);
						...
						$Lot_prod->prix_achat = $prix_Achat;
...
///////////////////////// inset into histo_achat table ///////////////////////:
		...
		///////////////// mise a jour de QTE stock produit ///////////////
					...
					if ($table_achat->Remise>0) {
						$Remise =  $table_achat->Remise	/ $table_achat->Quantite ;
						$Article->prix_achat = $table_achat->Prix - $Remise;
						$prix_Achat = $table_achat->Prix - $Remise ;
						}else{
							$Article->prix_achat = $table_achat->Prix;
							$prix_Achat = $table_achat->Prix ;
						}
