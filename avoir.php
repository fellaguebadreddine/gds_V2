                                        ...
                                        <div class="col-md-4">
                                        	<div class="form-group ">
                                       		...
                                       		<div class="col-md-4">
                                           		 ...
                                           		 <div class="form-group ">
													<label class="col-md-3 control-label">Référance </label>
													<div class="col-md-9">
														
															<input type="text" name = "Reference" id="Reference" class="form-control" placeholder="Référance " value="<?php if (isset($last_fournisseur->reference)) {echo $last_fournisseur->reference;  }?>"  required>
