					...
					<div class="col-xs-12">
						<table class="table  table-bordered " >
							...
							<tbody>
								...
								$list_achats = Avoir_achat::trouve_achat_par_facture($Fact->id_facture);
								}
						...
						<?php } ?>
							...
							<table  class="table" style="margin: 0px 0px 0px 0px !important;"  >
								...
								<?php $table_Reglements = Reglement_fournisseur::trouve_Reglement_par_id_facture($Fact->id_facture,$nav_societe->id_societe,3); ?>
											<tr>
