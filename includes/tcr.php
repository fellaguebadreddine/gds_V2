...
class Tcr {
	...
	protected static $nom_table="tcr";
	protected static $champs = array('id','father_rubriques','rubriques','debit_credit','is_bold');
	public $id;
	public $father_rubriques;
	public $rubriques;
	public $debit_credit;
	public $is_bold;
	...
	public static function trouve_33() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id <34");
  }
	public static function trouve_rest() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id >33");
  }
