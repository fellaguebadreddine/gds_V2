...
class Immobilisation {
	...
	protected static $nom_table="immobilisation";
	protected static $champs = array('id','id_societe','libelle','code','id_famille','nature','taux','date','valeur_achat','type_amortissement','N_andi','tva','autre_frais','ttc','N_facture','date_achat','date_debut_amortissement','duree','date_fin','cession','id_fournisseur','valeur_amortir_fiscal','type_cession','prix_cession','tva_cession','ttc_cession','comptes_immobilisation','comptes_amortissement','facture_scan','id_user','random');
	public $id;
	public $id_societe;
	public $libelle;
	public $code;
	public $type_amortissement;
	public $id_famille;
	public $nature;
	public $taux;
	public $date;
	...
	public $N_facture;
	public $date_achat;
	public $date_debut_amortissement;
	public $duree;
	public $date_fin;
	public $cession;
	public $type_cession;
	...
	public $tva_cession;
	public $ttc_cession;
	public $comptes_immobilisation;
	public $comptes_amortissement;
	public $id_user;
	public $random;
	...
	public static function trouve_immobilisation_par_societe($id){
