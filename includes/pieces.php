...
class Pieces_comptables {
	
	protected static $nom_table="pieces_comptable";
	protected static $champs = array('id','id_societe','id_op_auto','type_op','ref_piece','libelle','somme_debit','somme_credit','date','date_valid','journal','facture_scan','random');
	public $id;
	public $id_societe;
	public $id_op_auto;
	public $type_op;
	...
	public static function trouve_pieces_par_societe_and_Exercice($id,$date_debut,$date_fin){
    ...
    return  self::trouve_par_sql($q);
		...
		public static function trouve_pieces_par_societe($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_societe ={$id}";
    return  self::trouve_par_sql($q);
	}
