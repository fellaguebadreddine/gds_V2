...
class Facture_importation {
	
	protected static $nom_table="facture_importation";
	protected static $champs = array('id_facture','N_facture','Num_facture','id_fournisseur','id_societe', 'date_fac','date_valid','time','shipping', 'somme_ht','somme_tva','somme_ttc','somme_ht_frais','somme_tva_frais','somme_timbre_frais','somme_ttc_frais', 'mode_paiment', 'etat','facture_scan','id_g50','random');
	public $id_facture;
	public $N_facture;
	public $Num_facture;
	...
	public $somme_tva;
	public $somme_ttc;
	public $somme_ht_frais;
	public $somme_tva_frais;
	public $somme_timbre_frais;
	public $somme_ttc_frais;
	public $mode_paiment;
	public $etat;
	public $facture_scan;
	public $id_g50;
	...
	public static function trouve_importation_par_societe_etat_g50($id,$d1,$d2){
		$q =  "SELECT * FROM ".self::$nom_table;
		$q .= " WHERE id_societe ={$id}";
		$q .= " AND id_g50 = 0 ";
	...
	public static function trouve_importation_par_societe_etat_g50_not_selected($id,$d1,$d2){
		$q =  "SELECT * FROM ".self::$nom_table;
		$q .= " WHERE id_societe ={$id}";
		$q .= " AND id_g50 = 0 ";
		$q .= " AND date_fac BETWEEN  '{$d1}' and '{$d2}'";
