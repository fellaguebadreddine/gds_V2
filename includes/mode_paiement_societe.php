...
class Mode_paiement_societe {
	
	protected static $nom_table="mode_paiement_societe";
	protected static $champs = array('id','type','mode_paiement','id_societe','etat');
	public $id;
	public $type;
   ...
   public static function trouve_mode_paiment_autre_especes_par_societe($id_societe){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_societe ='{$id_societe}'";
	$q .= " AND mode_paiement =1";
	$q .= " ORDER BY `id`  ";
    return  self::trouve_par_sql($q);
	}

public static function trouve_mode_paiment_especes_par_societe($id_societe){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_societe ='{$id_societe}'";
	$q .= " AND mode_paiement =2";
	$q .= " ORDER BY `id`  ";
    return  self::trouve_par_sql($q);
	}
...
$sql .= " WHERE Id_voy =". $bd->escape_value($this->Id_voy) ;
$bd->requete($sql);
