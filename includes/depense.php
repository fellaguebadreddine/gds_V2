...
class Depense {
	...
	protected static $nom_table="depense";
	protected static $champs = array('id','id_societe', 'depense', 'comptes_depense','auxiliere_depense','id_person','random');
	public $id;
	public $id_societe;
	public $depense;
	public $comptes_depense;
	public $auxiliere_depense;
	public $id_person;
	public $random;
	
	
	public static function trouve_depense_par_societe($id){
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE depense = '".$this->depense."'";
