...
class Societe {
	...
	protected static $champs = array('id_societe','type','Dossier','Raison', 'Adresse', 'Ville', 'Postal','Taux_interet', 'Rc', 'Mf','Ai', 'Nis','Tel1','Tel2','Fax','Mob1','Mob2','Email','Web','Activite','Capital','Annee','exercice_debut','exercice_fin','Logo','Etat','comptes_vente','comptes_achat','comptes_remise_achat','comptes_remise_vente','auxiliere_remise_vente','auxiliere_remise_achat','auxiliere_achat','auxiliere_vente','journal_achat','journal_vente','journal_stock','journal_production','tva_achat','aux_tva_achat','wilayas','commune','inspection','recette','nature','journal_depense', 'random');
	public $id_societe;
	public $type;
	public $Dossier;
	public $Raison;
	...
	public $comptes_remise_achat;
	public $comptes_remise_vente;
	public $auxiliere_remise_vente;
	public $auxiliere_remise_achat;
	public $auxiliere_achat;
	public $auxiliere_vente;
	public $journal_achat;
	public $journal_vente;
	public $journal_depense;
	public $journal_stock;
	public $journal_production;
	public $tva_achat;
	public $aux_tva_achat;
	public $wilayas;
	public $commune;
	public $inspection;
	public $recette;
  ...
  public function nom_compler() {
    if(isset($this->Raison) && isset($this->prenom)) {
      return $this->Raison . " " . $this->prenom;
    } else {
      return "";
    }
  }
