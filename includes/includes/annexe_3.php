...
class Tab_amort_immob {
	
	protected static $nom_table="tab_amort_immob";
	protected static $champs = array('id','rubriques','amort','amort_sauf','immob','immob_sauf','is_bold','is_total');
	public $id;
	public $rubriques;
	public $amort;
	public $amort_sauf;
