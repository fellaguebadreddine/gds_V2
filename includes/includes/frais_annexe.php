...
class Frais_annexe {
	...
	protected static $nom_table="frais_annexe";
	protected static $champs = array('id','id_societe','designation','comptes_achat','comptes_vente','auxiliere_achat','auxiliere_vente','is_douane');
	public $id;
	public $id_societe;
	public $designation;
	...
	public static function trouve_frais_annexe_par_societe($id){
