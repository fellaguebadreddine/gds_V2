...
class Ibs {
	...
	protected static $nom_table="ibs_g50";    
	protected static $champs = array('id','trimestre','montant_payer_ibs','total_payer_ibs','id_user','id_g50');
	public $id;
   	public $trimestre;
	public $montant_payer_ibs;
	public $total_payer_ibs;
	public $id_user;
	public $id_g50;
