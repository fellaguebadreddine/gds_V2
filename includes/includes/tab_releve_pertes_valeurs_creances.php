...
class Tab_releve_pertes_valeurs_creances{
	
	protected static $nom_table="tab_releve_pertes_valeurs_creances";
	protected static $champs = array('id','id_annexe','Designation_debiteurs','Valeur_creance','Perte_valeur_constituee','date');
	public $id;
	public $id_annexe;
	public $Designation_debiteurs;
	public $Valeur_creance;
	public $Perte_valeur_constituee;
	public $date;




		public static function trouve_par_id_annexe($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_annexe ={$id}";
    ...
    $sql .= "WHERE id_annexe = '".$this->id_annexe."'";
    $sql .= "LIMIT 1";
...
public function supprime_par_id_annexe($id=0){
global $bd;
$sql = "DELETE FROM ".self::$nom_table;
$sql .= " WHERE id_annexe = {$id} " ;
$bd->requete($sql);
return($bd->affected_rows() == 1) ? true : false ;
	}
	}
