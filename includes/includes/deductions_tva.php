...
class Deductions_tva {
	
	protected static $nom_table="deductions_tva_g50";    
	protected static $champs = array('id','precompte','tva_achats_biens','tva_ded2','ded_compl','tva_recup','autre_ded','Total_deductions','TOTAL_dus','rever_ded','tot_rap','total_B','tva_paye','prec_repor','id_g50');
	public $id;
   	public $precompte;
	public $tva_achats_biens;
	public $tva_ded2;
	public $ded_compl;
	public $tva_recup;
	public $autre_ded;
