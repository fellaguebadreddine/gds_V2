...
class Accounts{
	...
	protected static $champs = array('id', 'user','mot_passe', 'phash', 'nom','prenom','type','compte_is_admin','compte_verifier','compte__permissions','date_creation','date_modif','date_der','adresse','wilaya','comune','id_agence','telephone','mobile','photo','facebook','twitter','active','date_active','active_by','date_block','block_by','id_societe');
	public $id;
	public $user;
	public $mot_passe;
	public $phash;
	...
	public $prenom;
	public $type;		
	public $compte_is_admin;
	public $compte_verifier;
	public $compte__permissions;
