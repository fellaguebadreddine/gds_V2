...
class Tab_affectation_resultat{
	
	protected static $nom_table="tab_affectation_resultat";
	protected static $champs = array('id','father_rubriques','rubriques','debit_credit','is_bold','is_total');
	public $id;
