...
class Famille_immobilisation {
	
	protected static $nom_table="famille_immobilisation";
	protected static $champs = array('id','id_societe','libelle','code','comptes_tva','comptes_dotation','journal_achat','journal_dotation','journal_cession','type_amortissement','duree','id_user','random');
	public $id;
	public $id_societe;
	public $libelle;
	public $code;
	public $comptes_tva;
	public $comptes_dotation;
	public $journal_achat;
	public $journal_dotation;
	public $journal_cession;
	...
	public static function trouve_famille_immobilisation_par_societe($id){
