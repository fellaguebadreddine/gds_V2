...
class Parametre {
	...
	protected static $nom_table="parametre";    
	protected static $champs = array('id','nom_entreprise','gerant', 'tel','fax','n_cf','n_rc','logo','adr','mobile','Timbre','TVA','fidalite_1','fidalite_2');
	public $id;
...
{ 
  ...
  return round($resultat); // Arrondi la valeur
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE ref_pro = '".$this->ref_pro."' ";
  ...
  public static function trouve_par_ref($id=0) {
