...
class Amortissement {
	...
	protected static $nom_table="amortissement";
	protected static $champs = array('id','id_societe','id_immobil','date','dure','valeur_amortir','dotation','dotation_cumulee','vnc','dotation_fiscale','ecart','rest_jours','random');
	public $id;
	public $id_societe;
	public $id_immobil;
	public $date;
	public $dure;
	public $valeur_amortir;
	public $dotation;
	public $dotation_cumulee;
	public $vnc;
	public $dotation_fiscale;
	public $rest_jours;
	public $ecart;
	public $random;
	
	public static function trouve_immobilisation_par_id_immobil($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_immobil ={$id}";
  ...
  public static function trouve_par_id_immobil($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_immobil={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
