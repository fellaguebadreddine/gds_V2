...
class Communes {
	...
	protected static $nom_table="communes";
	protected static $champs = array('id','code_postal', 'nom', 'wilaya_id');
	public $id;
	public $code_postal;
	public $nom;
	public $wilaya_id;
	
	public static function trouve_communes_par_id_wilayas($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE wilaya_id ={$id}";
