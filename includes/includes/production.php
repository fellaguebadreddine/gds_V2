...
class Production {
	...
	protected static $nom_table="production";    
	protected static $champs = array('id','id_societe','formule','produit_finale','qty','date','cout','dechet','random' );
	public $id;
	public $id_societe;
	public $formule;
	public $produit_finale;
	public $qty;
	public $date;
	public $cout;
	public $dechet;
  ...
  public static function trouve_par_random($id=0) {
	...
	public static function trouve_production_par_societe($id){
    ...
    $sql .= "WHERE produit_finale = '".$this->produit_finale."' ";
    $sql .= "and id_societe = '".$this->id_societe."'";
	 $sql .= "and formule = '".$this->formule."'";
   ...
   public static function trouve_par_id($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id  ={$id} LIMIT 1");
     ...
     public static function trouve_last_production_par_societe($id) {
