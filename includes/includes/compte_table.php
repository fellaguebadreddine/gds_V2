...
class Compte_table {
	...
	protected static $nom_table="comptes_table";
	protected static $champs = array('id','code','libelle');
	public $id;
	public $code;
	public $libelle;
	
	
	public static function insert_compte_comptable_par_societe($id){
	$q =  "INSERT INTO ".self::$nom_table;
	$q .= " SELECT code,libelle FROM comptes_table";
	$q .= " AND id_societe ={$id}";
	...
	public static function trouve_tous() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." ORDER BY id ASC");
  }
