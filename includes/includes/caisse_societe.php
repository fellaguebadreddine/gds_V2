...
class Caisse_societe {
	
	protected static $nom_table="caisse_societe";
	protected static $champs = array('id','id_caisse', 'id_societe','solde');
	public $id;
	public $id_caisse;
	public $id_societe;
	public $solde;
  ...
  public function nom_compler() {
	...
	public static function trouve_caisse_par_societe($id_societe){
	$q =  "SELECT * FROM ".self::$nom_table;
