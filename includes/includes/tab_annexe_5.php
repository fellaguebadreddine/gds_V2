...
class Tab_annexe_5{
	...
	protected static $nom_table="tab_annexe_5";
	protected static $champs = array('id','id_societe','date','random');
	public $id;
	public $id_societe;
	public $date;
	public $random;

public static function trouve_tab_annexe_5_par_societe_and_Exercice($id,$date_debut,$date_fin){
...
public static function trouve_annexe_5($id,$date_db,$date_fin){
	$q =  "SELECT * FROM ".self::$nom_table." WHERE id_societe ='".$id."' AND date BETWEEN '{$date_db}' AND '{$date_fin}'";
    return  self::trouve_par_sql($q);
	}	
  public static function trouve_par_random($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE random = {$id} LIMIT 1");
		...
		public static function trouve_annexe_par_societe($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_societe ={$id}";
    return  self::trouve_par_sql($q);
	}	
