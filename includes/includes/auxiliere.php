...
class Auxiliere {
	...
	protected static $nom_table="auxiliere";
	protected static $champs = array('id','code','id_societe','libelle','activite','rc','mf','ai','nis','adresse');
	public $id;
	public $code;
	public $id_societe;
	public $libelle;
	...
	public static function trouve_auxilere_par_societe($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_societe ={$id}";
    return  self::trouve_par_sql($q);
	}
	public static function trouve_auxilere_par_societe_id($id){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_societe ={$id}";
	$q .= " AND id ={$id}";
    return  self::trouve_par_sql($q);
	...
	public static function trouve_auxiliere_par_lettre_aux($id,$id_societe){
	global $bd ;
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE code LIKE  '{$id}%'";
