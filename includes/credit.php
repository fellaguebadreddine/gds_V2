...
class Credit {
	...
	protected static $nom_table="credit";
	protected static $champs = array('id','id_credit','num_clie', 'num_fac', 'date_ver');
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE id_credit = '".$this->ref_pro."' and id_credit = '0'  ";
	...
	return  self::trouve_par_sql($q);
	    ...
	    public static function trouve_par_fact($id=0) {
