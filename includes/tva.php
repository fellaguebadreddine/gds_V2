...
class Tva {
	...
	protected static $nom_table="tva";
	protected static $champs = array('id_tva','id_societe', 'Designation', 'taux','comptes_achat','comptes_vente','auxiliere_achat','auxiliere_vente');
	public $id_tva;
	public $id_societe;
	public $Designation;
	public $taux;
	...
	public $auxiliere_vente;
		...
		public static function trouve_tva_par_societe($id){
  ...
  public static function trouve_par_id($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_tva={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
  ...
  public static function trouve_par_sql($sql="") {
	...
	*/
	...
	public function save(){
	 ...
	 return isset($this->id_tva)? $this->modifier() : $this->ajouter();
	}
