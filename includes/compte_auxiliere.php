...
class Compte_auxiliere {
	
	protected static $nom_table="compte_auxiliere";
	protected static $champs = array('id','id_societe','aux','prefixe');
	public $id;
	public $id_societe;
	public $aux;
	public $prefixe;
	...
	public static function trouve_compte_auxiliere_par_societe($id){
    ...
    $sql .= "WHERE id_auxiliere = '".$this->id_auxiliere."'";
     $sql .= "LIMIT 1";
