...
class Avoir_vente {
	...
	protected static $nom_table="avoir_vente";
	protected static $champs = array('id','Type', 'id_facture','date_fact','id_societe', 'Quantite', 'Prix', 'id_client', 'id_prod','Code','Designation', 'id_person','Unite','Empl','Remise','Ht','Ttva','Tva','total','somme_ht','somme_tva','somme_ttc','id_lot','id_famille','Ht_achat','id_tva');
	public $id;
	public $Type;
	public $id_facture;
	public $date_fact;
