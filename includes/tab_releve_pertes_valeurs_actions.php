...
class Tab_releve_pertes_valeurs_actions{
	
	protected static $nom_table="tab_releve_pertes_valeurs_actions";
	protected static $champs = array('id','id_annexe','Filiales','Valeur_nominale','Perte_valeur_constituee','Valeur_nette','date');
	public $id;
	public $id_annexe;
	public $Filiales;
	public $Valeur_nominale;
